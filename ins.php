...
<h2 style="color:white;">INSPECTOR</h2>
<i class="fa fa-user-circle-o" style="font-size:30px;"></i> <b>Welcome Inspector: <?php echo strtoupper($_SESSION['ins']);?></b>
<a href="logout.php" >
...
<div class="container-fluid">
	...
	<div class="col-lg-6">
		<h4 align="center">MISSING PERSONS REGISTRATION</h4>
		...
		if (isset($_POST['missing'])) {
			...
			mysqli_query($conn, "INSERT INTO missing (fname, loc_last_seen, img, eye_color, hair_color, height, time_last_seen, age, gender, wearing) VALUES ('".$_POST['fname']."', '".$_POST['loc']."', '$loc','".$_POST['eye']."', '".$_POST['hair']."', '".$_POST['height']."', '".$_POST['tym']."', '".$_POST['age']."', '".$_POST['gender']."', '".$_POST['wearing']."')");

			echo "<script>alert('Missing person\'s profile uploaded successfully!'); window.location = 'ins.php'</script>";
		}
		...
		?>
			<form method="POST" action="#" style="border:none;" enctype="multipart/form-data">
				...
				<label>Was Wearing?: </label>
				<textarea rows=5 class="form-control" name="wearing" required style="background-color:#000;border-bottom:6px solid lightgreen;color:white;"></textarea><br/>

				<input type="submit" name="missing" value="Register Missing Person" style="" class="btn btn-success"/>
			</form>
	</div>
	<div class="col-lg-6">
